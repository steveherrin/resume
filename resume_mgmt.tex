...
\begin{resume}
    ...
    \textbf{23andMe}, Sunnyvale, CA \hfill\vspace{1mm}\hfill January 2014 -- present\\%\vspace{-1mm}
    \textsl{Engineering Manager / Tech Lead (2.5 years)}
    \begin{itemize}
    \item Built 3 machine learning and data -focused teams, containing 16 ICs: leads, senior, and junior level
    \item Supervised technical and data science aspects of 4 machine learning projects from R\&D to production
    ...
    \item Led team to build a web-based portal that allows internal and external researchers to dynamically query anonymized data stored in HBase for \textgreater 5 million customers using a SQL-like interface
    \item Formed and led committee of leads to standardize interviewing guidelines and open source processes\\\vspace{-6mm}
    \end{itemize}
   \textsl{Engineering Individual Contributor (4 years)}\\\vspace{-4mm}
    \begin{itemize}
    ...
    \item Created Genotyping Services, a Django webapp on AWS allowing external researchers to easily run genomic studies, increasing sales by over 2\% and leading to strategic data-sharing agreements\\\vspace{-6mm}
    ...
    %\end{itemize}
    %\textsl{Engineering management) (1.5 yrs)}
    %\begin{itemize}
    \end{itemize}
    ...
    \item Mentored 1--2 junior graduate students (at any given time) on lab, coding, and statistical technique\\\vspace{-6mm}
    \end{itemize}
