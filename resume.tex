...
\begin{resume}
    ...
    \textbf{23andMe}, Sunnyvale, CA \hfill\vspace{1mm}\\\vspace{1mm}%
    \textsl{Engineering Manager: Machine Learning \& Data Services Team}\hfill March 2018 -- present\vspace{1mm}\\\vspace{-3mm}%
    \begin{itemize}
    \item Developed and automated a maximum likelihood analysis to identify and flag bad probes genotyping probes among the roughly million on the platform
    \item Worked with engineering leads to standardize interviewing guidelines and open source release processes across the organization
