...
%________________________________________________________________________________________________
   ...
   % \end{itemize}
    ...
    \vspace{1mm}\\\vspace{0mm}%
    \textbf{Other:} Machine Learning, Data Analysis, Bayesian/Frequentist Statistics, Simulation, CI/CD, Sensors, Analog \& Digital Electronics, Scientific Computing, Neutrino \& Particle Physics, Radio (Amateur Extra License), Experienced Underground Miner
