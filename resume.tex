...
\begin{resume}
    ...
    \item Grew a data-focused engineering team from 2 engineers to 3 teams totalling 16 engineers
    \item Supervised 2 leads to coordinate work across teams for a mix of junior and senior individual contributors
    \end{itemize}
