...
\begin{resume}
    ...
    \begin{itemize}
    \item Led engineering team (supervising 3--4 engineers) to create Genotyping Services, a Django and Backbone JS webapp that allows external researchers to easily run studies, opening a new channel that increased sales by over 2\%.
    \item Led team responsible for a web-based portal that allows internal and external researchers access to dynamically-computed aggregate statistics on anonymized data stored in HBase for \textgreater 2 million customers.
    ...
    \textbf{Languages:} Python, C++, Rust, SQL, Bash Shell Scripting, PHP, MATLAB/Octave, Mathematica (some experience), Java (some experience), JavaScript (some experience), R (some experience)
