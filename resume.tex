...
\begin{resume}
    ...
    \item Created and validated a heuristic algorithm for parking recommendations using Python. The algorithm reduces bike theft risk by 38\% while requiring only 150~ft more walking on average.
