...
\begin{resume}
    ...
    \begin{itemize}
    \item Developed and automated a maximum likelihood analysis that flagged \(\sim0.5\%\) bad genotyping probes for replacement in future platforms
    ...
    \item Led team to build a web-based portal that allows internal and external researchers to dynamically query anonymized data stored in HBase for \textgreater 5 million customers
